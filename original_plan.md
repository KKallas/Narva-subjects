...
Students work in teams (1–5 members, ideally 4 teams) across courses, all solving the same problem — within each team, members divide responsibility for different subsystems. Try different roles: lead documentation one time, build the prototype the next. By the final Prototyping course, students cherry-pick the best solutions from all teams to build their own integrated system.

The logic is simple: learn by building something that matters, together.

### **Assessment Philosophy**

Each course follows the same structure: six projects (five small, one comprehensive), working in teams of 1–5. Small projects worth 20 points each (5×20 \= 100 points). Integration project offers two paths: 40 points as supplement to assignments, or 100 points as standalone alternative. Maximum 100 points from base work, plus bonus opportunities.
...
Students work in teams of 1–5 (ideally 4 teams) to develop increasingly sophisticated systems. Each device gets its own intelligent user interface. This year's practical project involves creating a syringe dispenser for the Dobot robot with a user-friendly web interface for monitoring and control.
...
Students work in teams throughout the year and integrate the best solutions from all groups in their final prototypes. Within your team, try different roles — it builds a broader engineering perspective. This collaborative approach mirrors real engineering practice while ensuring individual mastery.
