# Narva Kolledži tehnikaõppekava 2026/27

## Roboti doseerimissüsteemi ehitamine

### Suur pilt

Kõik neli ainet ehitavad ühte süsteemi: MG400 robotkäele professionaalse doseerimissüsteemi. Robot ja kompressor on olemas — tudengid ehitavad tööriistakomplekti mis muudab €3000 roboti kasulikuks.
...
4 meeskonda, kuni 5 liiget igaühes (max 20 tudengit). Iga meeskond saab oma MG400 ja oma töölaualõigu. Meeskonnasiseselt jagunevad rollid: keegi vastutab andurite, keegi tarkvara, keegi mehaanika, keegi dokumentatsiooni eest. Rolle vahetatakse verstapostide vahel.
...
│   └── integration/
├── prototyping/              ← 2. semester
│   ├── milestone1/           ← Audit + spetsifikatsioon
│   ├── milestone2/           ← Integratsiooni prototüüp
│   ├── milestone3/           ← ML juurutamine
│   ├── milestone4/           ← Korpusega prototüüp
│   ├── milestone5/           ← Tootmisvalmis süsteem
│   └── full-project/         ← Tervikprojekti alternatiiv
...
* `prototyping-milestone1`, `prototyping-milestone5`
...
*Kõik kokku + masinõpe tootmises*

### Mõte

Kolme aine komponendid tulevad kokku üheks töötavaks süsteemiks. Aga see pole ainult kokkupanek — siin lisandub masinõpe kui tööriist. Eelmised ained tootsid andmeid ja ehitasid mudeleid. Prototüüpimises pannakse mudel tööle: süsteem mis kalibreerub ise, ennustab tulemust ja kohaneb uute tingimustega.

Teine semester, tudengitel on juba: töötavad andurid (Andmehõive), veebiliides ja API (Nutilahendused), mehaanilised komponendid (3D Print). Kui midagi on poolik — esimene verstapost on selleks et lõpetada.

### Mida õpid

* Süsteemiintegratsioon: elektroonikat + tarkvara + mehaanika üheks tervikuks
* ML mudeli juurutamine füüsilisele süsteemile
* Adaptiivne juhtimine: mudel → prognoos → korrigeerimine → uus mõõtmine
* Tootmisvalmis dokumenteerimine
* Demo ja kaitsmine

### Töö

Tudeng valib: 5 verstaposti järjest (× 20p = max 100p) VÕI tervikprojekt (max 100p).

**Verstapost 1: Süsteemi audit ja spetsifikatsiooni uuendus (10h)**

Kõik kolm ainet on tehtud (või osaliselt). Mis töötab? Mis on poolik? Mis vajab ümbertegemist?

Konkreetselt:
* Koosta süsteemi hetkeseisu audit: iga alamsüsteem (andurid, tarkvara, mehaanika) — olek, puudused, riskid
* Uuenda spetsifikatsioon esimese semestri kogemuse põhjal
* Defineeri: mis on minimaalne töötav süsteem (MVP) mis demonstreerib ML kalibratsiooni?
* Ajakava ja tööjaotus ülejäänud verstapostideks

**Verstapost 2: Integratsiooni prototüüp (16h)**

Ühenda kõik alamsüsteemid esimest korda.

Konkreetselt:
* MG400 + süstlahoidik + andurid + ESP32 + veebiliides — kas terve ahel töötab?
* Esimene automatiseeritud doseerimistsükkel: veebist käsk → MG400 liigub → kompressor doseerib → andurid mõõdavad → andmed salvestuvad
* Tuvasta integratsioonimured: ajastus, latentsus, juhtimisolekud
* Kogu esimesed 100 mõõtmist integreeritud süsteemiga

**Verstapost 3: ML mudeli juurutamine (18h)**

Andmehõive ülesandes 5 treenitud täitetaseme mudel läheb nüüd tööle.

Konkreetselt:
* Lae treenitud mudel (pickle/joblib) Flask serverisse
* Suletud ahel: MG400 doseerib → rõhuandur mõõdab → mudel hindab järelejäänud mahtu → veebiliides näitab "süstlas on ~4.2ml"
* Lisa lävendi alarm: kui mudel ennustab alla 2ml → hoiatus operaatorile veebiliideses
* Testi: pane uus täis süstal, doseeri kuni tühjaks — kas mudeli hinnang langeb mõistlikult?
* Testi: proovi teise meeskonna mudelit oma seadmel — kas töötab? Kui ei, siis miks? (erinev süstal, materjal, temperatuur)

**Verstapost 4: Korpusega funktsionaalne prototüüp (16h)**

Kõik kokku, korralik kaablihaldus, kasutajaliides mis on arusaadav ka mitte-insenerile.

Konkreetselt:
* Paigalda kõik komponendid 3D prinditud korpustesse ja töölaua moodulitesse
* Kaablihaldus: märgistatud ühendused, vooliku pikkused, kinnitused
* UX test: anna süsteem teisele meeskonnale — kas nad saavad 10 minutiga doseerima?
* Hooldusjuhend: mis läheb katki, kuidas vahetada

**Verstapost 5: Tootmisvalmis süsteem (14h)**

Lõplik süsteem koos dokumentatsiooniga mida saab kopeerida.

Konkreetselt:
* Täielik dokumentatsioonipakett: kasutusjuhend, hooldusjuhend, osade nimekiri, tarkvara paigaldusjuhend
* Kogu süsteemi demonstratsioon: spetsifikatsiooni sihtväärtused vs. tegelik jõudlus
* GitHub repo: kood, CAD failid, BOM, juhendid
* 5-minutiline demo: "nii töötab süsteem, nii saab selle üles seada, nii kalibreerub ML mudel"

**Tervikprojekt (alternatiiv)**

Sama sisu, kaitstakse korraga. Nõuab füüsiliselt töötavat prototüüpi — puhtalt teoreetiline töö ei kvalifitseeru.

### Kontakttundide ajakava

* **[27.02.27]** Süsteemi audit, integratsiooni planeerimine
* **[27.02.27]** Verstaposti 1 kaitsmine
* **[20.03.27]** Verstaposti 2 kaitsmine
* **[20.03.27]** ML mudeli juurutamise töötuba (pickle → Flask → MG400 ahel)
* **[17.04.27]** Verstaposti 3 kaitsmine
* **[17.04.27]** Tootmisprototüübi dokumenteerimine
* **[29.05.27]** Verstaposti 4 kaitsmine
* **[29.05.27]** Verstaposti 5 kaitsmine / Tervikprojekti kaitsmine
...
└────────────────────────────┬─────────────────────────────┘
                             │
                             ▼
Semester 2 (veeb — mai 2027):
┌──────────────────────────────────────────────────────────┐
│ Prototüüpimine                                           │
│ ────────────────                                         │
│ V1: Audit + spetsifikatsioon                             │
│ V2: Integratsioon (terve ahel esimest korda)             │
│ V3: ML juurutamine (suletud tagasisideahel)              │
│ V4: Korpusega prototüüp                                  │
│ V5: Tootmisvalmis süsteem                                │
└──────────────────────────────────────────────────────────┘
```
...
|:---|:---|:---|
| Andmehõive L1-L2 | Rõhuandur + op-amp + filter (maketeerimisplaadil) | Andmehõive Ü4, Prototüüpimine V2 |
| Andmehõive L3 | dP/dt IRQ ohutusmehanism + VL53L0X otsiku kalibreerimine | Prototüüpimine V2 |
| Andmehõive L3 | PCB (Gerber tellitud) | Prototüüpimine V4 |
| Andmehõive Ü5 | Treenitud ML mudel (täitetaseme hindamine rõhukõverast) | Prototüüpimine V3 |
| Nutilahendused L1 | RPI juhtimisstation + MG400 Python wrapper | Andmehõive Ü4, Prototüüpimine V2 |
| Nutilahendused L2 | ESP32 ↔ RPI integratsioon | Andmehõive Ü4 |
| Nutilahendused L3 | VPN kaugtunnel (Digital Ocean + WireGuard) | Prototüüpimine V5 |
| Nutilahendused Ü4 | MQTT + InfluxDB + ühtne veebiliides RPI-l | Andmehõive Ü4-Ü5, Prototüüpimine V4 |
| Nutilahendused Ü5 | REST API + LLM liides | Prototüüpimine V5 |
...
| 3D Print L3 | Elektroonika korpus (ESP32 + op-amp + PCB) | Prototüüpimine V4 |
| 3D Print Ü5 | Testpingi raam (alumiinium + prinditud sisestused) | Prototüüpimine V5 |
